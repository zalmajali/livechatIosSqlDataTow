...
@NgModule({
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },VideoEditor,Globalization,Camera,AppVersion,SocialSharing,FirebaseMessaging,Network,Chooser,Device,FileTransfer,FilePath,AndroidPermissions,StatusBar,SQLite,File],
